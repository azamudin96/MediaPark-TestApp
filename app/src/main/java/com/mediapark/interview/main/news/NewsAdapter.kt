...
class NewsAdapter (var callback: OnItemClickListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return NewsItemHolder(binding, callback)
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when(holder) {
            is NewsItemHolder -> holder.onBind(position, arrayData[position])
        }
    }
    ...
    class NewsItemHolder internal constructor(var binding: LayoutNewsListItemBinding, var callback: OnItemClickListener) : BaseViewHolder(binding.root), View.OnClickListener {
